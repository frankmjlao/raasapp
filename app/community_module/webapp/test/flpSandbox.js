		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Recommended Community Blogs v1.0",
									"targetURL": "#RecommendedCommunityBlogsv10-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"RecommendedCommunityBlogsv10-display": {
								"semanticObject": "RecommendedCommunityBlogsv10",
								"action": "display",
								"description": "Fiori application for community blogs",
								"title": "Recommended Community Blogs v1.0",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=communitymodule",
									"url": sap.ui.require.toUrl("communitymodule")
								}
							}
						}
					}
